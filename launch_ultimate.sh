#!/bin/bash
# SkyJames Ultimate Launcher

echo "🚀 SkyJames Ultimate Edition"
echo "============================="
...
echo "📈 Starting Ultimate Dashboard on port 8501..."
streamlit run scripts/dashboard_final.py --server.port 8501 --server.headless true &
sleep 2
...
echo "  - Ultimate Dashboard: http://localhost:8501 (Webcam + Detection)"
